...
async def search_weather_kabankalan():
    ...
    print("🌤️  Neo-Clone Weather Search Test")
    print("=" * 50)
                ...
                for selector in selectors:
                    try:
                        ...
                        if element:
                            ...
                            print("\n🌡️  Extracting weather information...")
                            ...
                            if weather_data:
                                ...
                                print("  ⚠️  No specific weather widget detected")
                            ...
                            if 'kabankalan' in page_content.lower():
                                ...
                                print("  ⚠️  Kabankalan City may not be clearly mentioned")
