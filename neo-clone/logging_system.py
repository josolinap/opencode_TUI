...
class InteractionLog:
    timestamp: str
    session_id: str
    event_type: str  # 'user_message', 'skill_execution', 'error', 'system'
...
class NeoLogger:
    ...
    def _setup_file_handler(self, logger: logging.Logger, filename: str, 
                          formatter: logging.Formatter, max_bytes: int, backup_count: int):
    ...
    def log_skill_execution(self, skill_name: str, user_input: str, 
    ...
    def log_error(self, error_type: str, error_message: str, 
        ...
        log_entry = InteractionLog(
            ...
            event_type="error",
            error_message=error_message,
            metadata={"error_type": error_type, "context": context, **(metadata or {})}
        )
        self._write_interaction_log(log_entry)
    ...
    def log_performance(self, operation: str, execution_time_ms: float, 
        ...
        # Add to interaction log for analytics
        log_entry = InteractionLog(
            timestamp=datetime.now().isoformat(),
            session_id=self.session_id,
    ...
    def _write_interaction_log(self, log_entry: InteractionLog):
        ...
        with self._lock:
            try:
                ...
                # Fallback to regular logging if JSONL fails
    ...
    def get_skill_statistics(self) -> Dict[str, Any]:
        ...
        try:
            skill_stats = {}
            recent_logs = self.get_recent_logs(limit=1000)  # Last 1000 entries
...
# Context manager for skill execution logging
class SkillExecutionContext:
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        ...
        if exc_val:
            self.logger.log_skill_execution(
